                            ...
                            <td class="para">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                                        <li><a href="{{route('admin.lease.edit', ['id' => $item->id])}}"><i class="fa fa-pencil fa-lg"></i> Redaguoti</a></li>
                                        <li><a target="_blank" href="{{route('order', $item->order['token'])}}"><i class="fa fa-pencil fa-lg"></i> Peržiūrėti</a></li>
                                        <li><a href="#" data-href="{{route('admin.lease.remove', ['id' => $item->id])}}" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o fa-lg"></i> Itrinti</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
