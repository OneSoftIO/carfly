                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                @if(!empty($vehicle->car_year))
                                                    <td><i class="fa fa-car" data-toggle="tooltip"
                                                           data-original-title="Tekstas"></i> {{$vehicle->car_year}}
                                                    </td>
                                                @endif
                                                @if(!empty($vehicle->fuel_type))
                                                    <td><i class="fa fa-dashboard" data-toggle="tooltip"
                                                           data-original-title="Tekstas"></i> {{__('car.'.$vehicle->fuel_type)}}
                                                    </td>
                                                @endif
                                                @if(!empty($vehicle->gearbox))
                                                    <td><i class="fa fa-cog" data-toggle="tooltip"
                                                           data-original-title="Tekstas"></i> {{__('car.'.$vehicle->gearbox)}}
                                                    </td>
                                                @endif
                                                @if(!empty($vehicle->doors))
                                                    <td><i class="fa fa-hdd-o" data-toggle="tooltip"
                                                           data-original-title="Tekstas"></i> {{$vehicle->doors}}</td>
                                                @endif
                                            </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="widget-content">
                                    @if($order->isPending() && !$order->isCash())
                                        <div class="form-group">
                                            <textarea name="message" id="fad-message" class="form-control alt"
                                                      placeholder="@lang('page.additional_info_content')..." cols="30"
                        ...
                        <div class="col-md-7 col-xs-12">
                                    ...
                                    <div id="responsive-table">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="fa fa-calendar"></i> {{$order->booking->from}}<br> <i
                                                            class="fa fa-location-arrow"></i> {{isset($pickup)? $pickup : null}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>@lang('page.leave_destination')</td>
                                                <td><i class="fa fa-calendar"></i> {{$order->booking->until}}<br> <i
                                                            class="fa fa-location-arrow"></i> {{isset($dropoff)? $dropoff:null}}
                                                </td>
                                            </tr>
                                            {{--<tr>--}}
                                        ...
                                        <div class="panel-group payments-options" id="accordion" role="tablist"
                                                    ...
                                                    <div class="panel-heading" role="tab" id="headingOne">
                                                        <h4 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion"
                                                               ...
                                                               aria-controls="collapseOne" data-value="paysera">
                                                                <span class="dot"></span> @lang('page.ban_trans_or_payment')
                                                            </a>
                                                            <span class="overflowed pull-right"><img
                                                                        src="{{asset('assets/img/preview/payments/paysera.png')}}"
                                                                        alt=""/></span>
                                            ...
                                            <div class="panel panel-default {{!$onlinePayments->isActive()?'radio':null}}">
                                                <div class="panel-heading" role="tab" id="headingTwo">
                                                    <h4 class="panel-title">
                                                        <a class='{{$onlinePayments->isActive()?'collapsed':null}}'
                                                           data-toggle="collapse" data-parent="#accordion"
                                                           href="#collapse2"
                                                           aria-expanded="{{!$onlinePayments->isActive()?'true':'false'}}"
                                                           aria-controls="collapseTwo" data-value="cash">
                                                            <span class="dot"></span> @lang('page.cash')
                                                        </a>
                                                    </h4>
                                                </div>
                                                <div id="collapse2"
                                                     class="panel-collapse collapse {{!$onlinePayments->isActive()?'in':null}}"
                            ...
                            <div class="widget shadow">
                                ...
                                <div class="widget-content">
                                    ...
                                    @if($order->isPending() && !$order->isCash())
                                        <div class="checkbox pull-left" title="@lang('page.confirm_terms')"
                                             data-toggle="tooltip">
                                            <input id="accept" type="checkbox" name="fd-name">
                                            <label for="accept">@lang('page.confirm_with') <a target="_blank"
                                                                                              href="{{route('other.page', 'nuomos-salygos')}}">@lang('page.terms')
                                                    .</label>
                                        </div>
                                        <div class="pull-right">
                                            {{--<a href="#" data-toggle="modal" data-target="#help">Pagalbos? </a>--}}
                                            <button type="submit"
                                                    class="btn btn-theme confirm-order">@lang('page.confirm_order')</button>
                                        </div>
                                        <div class="clearfix"></div>
                                </div>
                                @endif
