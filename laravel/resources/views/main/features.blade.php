        ...
        <div class="row">
            <div class="col-md-4 wow flipInY" data-wow-offset="70" data-wow-duration="1s">
                <div class="thumbnail thumbnail-featured no-border no-padding">
                    <div class="media">
                        <a class="media-link" href="#" data-toggle="modal" data-target="#myModal">
                            <div class="caption">
                                <div class="caption-wrapper div-table">
                                    <div class="caption-inner div-cell">
                                        ...
                                        <div class="buttons">
                                            <button type="button" class="btn btn-theme ripple-effect btn-theme-transparent" data-toggle="modal" data-target="#myModal">Read More</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-4 wow flipInY" data-wow-offset="70" data-wow-duration="1s" data-wow-delay="200ms">
                <div class="thumbnail thumbnail-featured no-border no-padding">
                    <div class="media">
                        <a class="media-link" href="#" data-toggle="modal" data-target="#myModal2">
                            <div class="caption">
                                <div class="caption-wrapper div-table">
                                    <div class="caption-inner div-cell">
                                        ...
                                        <div class="caption-text">Duis bibendum diam non erat facilaisis tincidunt. Fusce leo neque,lacinia at tempor vitae, porta at arcu.</div>
                                        <div class="buttons">
                                            <button type="button" class="btn btn-theme ripple-effect btn-theme-transparent" data-toggle="modal" data-target="#myModal2">Read More</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-4 wow flipInY" data-wow-offset="70" data-wow-duration="1s" data-wow-delay="400ms">
                <div class="thumbnail thumbnail-featured no-border no-padding">
                    <div class="media">
                        <a class="media-link" href="#" data-toggle="modal" data-target="#myModal3">
                            <div class="caption">
                                <div class="caption-wrapper div-table">
                                    <div class="caption-inner div-cell">
                                        ...
                                        <div class="caption-text">Duis bibendum diam non erat facilaisis tincidunt. Fusce leo neque,lacinia at tempor vitae, porta at arcu.</div>
                                        <div class="buttons">
                                            <button type="button" class="btn btn-theme ripple-effect btn-theme-transparent" data-toggle="modal" data-target="#myModal3">Read More</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
