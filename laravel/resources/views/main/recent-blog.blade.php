<section class="page-section recent-blog-section">
    <div class="container">
                ...
                <div class="recent-post alt">
                    <div class="media">
                        <a class="media-link" href="#">
                            ...
                            <img class="media-object" src="{{asset('assets/img/preview/blog/recent-post-570x270x1.jpg')}}" alt="">
                ...
                <div class="recent-post alt">
                    <div class="media">
                        <a class="media-link" href="#">
                            ...
                            <img class="media-object" src="{{asset('assets/img/preview/blog/recent-post-570x270x2.jpg')}}" alt="">
                            <i class="fa fa-plus"></i>
                        </a>
                        <div class="media-left">
                            <div class="meta-date">
